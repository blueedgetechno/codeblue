...
var data = [
  "Life is too short for finding matching socks. Albert Einstein",
  ...
  "Don't search for the meaning of life. Simply be present for the people you love. Maxime Lagac",
  ...
  "Life can be simple and beautiful. Focus on the good things. Maxime Lagac",
  ...
  "You're never wrong if you love and help people. Maxime Lagac",
  ...
  "If you're lucky, family members are friends, and friends are family members. Maxime Lagac",
  "Make sure they know you love them. Maxime Lagac",
  ...
  "Those who truly want something will keep trying until they die. Maxime Lagac",
  ...
  "Be your own hero. Maxime Lagac",
  "I prefer to die trying. Maxime Lagac",
  ...
  "What's the tiniest step you can take? Do that first. Maxime Lagac",
  ...
  "Part 3. Motivational Quotes About",
  ...
  "Effort is only effort when it begins to hurt. Jos Ortega y Gassett",
  ...
  "Don't ask for what the world needs. Ask what makes you come alive, and go do it. Bren Brown",
  ...
  "Deep down you know what you want. Deep down you have what it takes. Maxime Lagac",
...
const setup = (wd, prob, ext, inputs, outputs) => {
  ...
  var quote = data[Math.floor(Math.random() * data.length)].trim()
  var com = ""
  if(ext==".py") com = "# "
